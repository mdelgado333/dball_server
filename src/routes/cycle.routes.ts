...
import { newTrainingCycle, getTrainingCycle, getAllTrainingCycles, updateTrainingCycle, addWorkoutToTrainingCycle, deleteWorkoutFromTrainingCycle, deleteTrainingCycle } from '../controllers/cycle.controller'
